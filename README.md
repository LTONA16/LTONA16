...
I am an **Information Systems Engineering student** with a strong focus on **DevOps, Cloud Computing, Server Management, and Cybersecurity**. I specialize in building automated CI/CD pipelines, managing Linux and Windows environments, and developing full-stack applications.

---

## About Me

- 🎓 **Education:** Information Systems Engineering at Universidad de Sonora (2022 - 2026)
- 💼 **Current Role:** DevOps Engineer at CSI PRO
- 🛠️ **Core Focus:** Automating workflows, cloud infrastructure optimization, and securing systems.
...
| :--- | :--- |
| **DevOps & Cloud** | CI/CD, GitHub Actions, Docker, IaC, VMs, AWS, Azure |
| **OS & SysAdmin** | Linux, Windows Server, Active Directory, Bash, Networking (DNS, DHCP, FTP, SSH) |
| **Backend & Databases** | Python, Java, C#, ASP.NET MVC, Springboot, MySQL, Microsoft SQL Server |
| **Frontend & Hardware** | React, Vue, JavaScript, HTML, CSS, Arduino |
